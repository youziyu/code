                    ...
                    <ul>
                      <?php
                       for($i=0;$i<count($nav);$i++){
                        //    echo $nav[$i];
                        echo '<li>';
                            for($j=0;$j<count($nav[$i]);$j++){
                                if($j==0){
                      echo '<a href="./waterfall_1.html" class="toplist">'.$nav[$i][$j].'</a>';
                                }else{
                      echo '<a href="./waterfall_1.html">'.$nav[$i][$j].'</a>';
                                }
                    ...
                    <div class="wrap">
                        <?php
                            for($i=0;$i<count($pics);$i++){
                             echo '<a href="#"><img src="'.$pics[$i].'" width="710" /></a>';
                            }
                        ?>
